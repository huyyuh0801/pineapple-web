...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 border-b bg-white">
      <div className="mx-auto flex w-full max-w-6xl items-center gap-6 md:gap-10 px-4 sm:px-6 py-5 md:py-6">
        {/* LOGO */}
        <Link href="/" className="flex items-center">
          <Image
            ...
            priority
            quality={100}
            className="h-14 w-28 sm:h-16 sm:w-32 md:h-20 md:w-40 object-contain"
          />
        </Link>
      ...
      {/* MOBILE + TABLET */}
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 pb-4 lg:hidden">
        {/* Tabs + icons gọn nhất: cùng 1 hàng, tự wrap khi thiếu chỗ */}
